...
], Temperature.prototype, "light_sensor", void 0);
__decorate([
    (0, mongoose_1.Prop)([
        {
            sensor_id: { type: String, required: true },
    ...
    __metadata("design:type", Array)
], Temperature.prototype, "soilmoisture_sensor", void 0);
__decorate([
    (0, mongoose_1.Prop)([
        {
            sensor_id: { type: String, required: true },
    ...
    __metadata("design:type", Array)
], Temperature.prototype, "humidity_sensor", void 0);
__decorate([
    (0, mongoose_1.Prop)([
        {
            sensor_id: { type: String, required: true },
    ...
    __metadata("design:type", Array)
], Temperature.prototype, "temperature_sensor", void 0);
